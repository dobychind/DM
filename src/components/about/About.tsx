...
const About: React.FC<{ forwardRef: React.RefObject<HTMLDivElement> }> = ({ forwardRef }) => {
  return (
    <div ref={forwardRef} className='flex h-screen flex-col pt-7 border bg-gradient-to-b from-bg to-bg items-center'>
      <h3 className='text-main text-5xl font-bold text-center'>О компании</h3>
      <div className='flex w-2/3 mx-auto py-12 items-center justify-between'>
      ...
      <div className='grid grid-cols-2 w-3/4 gap-x-12 gap-y-8'>
