...
const Counters = () => {
    return (
        <div className='w-full flex flex-col gap-10 md:gap-8'>
            <h2 data-aos-once="true" data-aos="fade-down" data-aos-duration="3000" className='text-black font-semibold text-2xl md:text-3xl 2xl:text-3xl text-center md:text-start'>"Даниэль М" сегодня</h2>
