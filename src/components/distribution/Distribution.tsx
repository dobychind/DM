...
const Distribution: React.FC<{ forwardRef: React.RefObject<HTMLDivElement> }> = ({ forwardRef }) => {
    ...
    return (
        <div data-aos="fade-down" data-aos-duration="3000" data-aos-once="true" data-aos-anchor-placement="top" className="w-full">
            <div ref={forwardRef} className="flex w-full flex-col py-8 md:px-8 md:py-16 bg-white rounded-2xl mx-auto items-center justify-center gap-12">
                <div className='flex flex-col px-2 md:px-0 w-full gap-12 justify-between'>
                    <div className='flex w-full flex-col-reverse xl:flex-row-reverse gap-12 justify-between '>
                        ...
                        <div className='flex justify-center 2xl:justify-around  items-center 2xl:items-start flex-col gap-12 xl:max-w-[60vw]'>
                ...
                <div className='flex flex-col gap-3 md:p-6 px-2 md:px-0'>
                    ...
                    <div data-aos="fade-down" data-aos-duration="3000" data-aos-once="true" data-aos-anchor-placement="top-bottom" >
                        <div className='grid grid-cols-1 gap-3 md:p-0 md:gap-12 md:grid-cols-2 xl:grid-cols-4 '>
                ...
                <div className='flex flex-col gap-8 w-full'>
                    ...
                    <div data-aos="fade-down" data-aos-once="true" data-aos-duration="3000" data-aos-anchor-placement="top-bottom" data-aos-delay="500" className='max-w-[96vw] overflow-hidden'>
                        <ClientSwiper />
                    </div>
                </div>
            </div>
