    ...
    return (
        ...
        >
            <SwiperSlide className="flex border border-main p-3 rounded-2xl flex-col gap-4 md:gap-6 items-center min-h-[150px] h-full">
                ...
                <div className="flex items-center justify-center w-full text-xl md:text-3xl   text-center ">
                    Начало работы Группы компаний "Даниэль М" в сфере производства хлебобулочных изделий
                </div>
            </SwiperSlide>

            <SwiperSlide className="flex border border-main p-3 rounded-2xl flex-col gap-4 md:gap-6 items-center min-h-[150px] h-full">
                <div className="flex w-full items-center justify-around text-xl md:text-3xl  min-[1920px]:text-4xl text-main">
                    Февраль - март <p className="text-5xl min-[1920px]:text-7xl">2018</p>
                </div>
                <div className="flex items-center justify-center w-full text-center text-xl md:text-3xl ">
            ...
            <SwiperSlide className="flex border border-main p-3 rounded-2xl flex-col gap-4 md:gap-6 items-center min-h-[150px] h-full">
                <div className="flex w-full items-center justify-around text-xl md:text-3xl  text-main min-[1920px]:text-4xl">
