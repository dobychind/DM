...
const Services = () => {
    ...
    return (
        <div className='flex flex-col gap-8 justify-center w-full'>
            <h4  data-aos="fade-down" className='text-black text-3xl text-start font-medium'>Ответственное хранение и доставка груза</h4>
            <div data-aos="fade-down" data-aos-duration="1500" className='grid grid-cols-1 gap-6 md:grid-cols-2 xl:grid-cols-3 md:gap-8 '>

                <div  className='flex bg-white justify-around gap-6 items-center p-8  border border-main rounded-2xl'>
                ...
                <div className='flex bg-white justify-center gap-6 items-center p-8 border border-main rounded-2xl'>
                ...
                <div className='flex bg-white justify-center gap-6 items-center p-8 border border-main rounded-2xl box-border'>
