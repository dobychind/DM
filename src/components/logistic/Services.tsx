...
const Services = () => {
    ...
    return (
        <div className='flex flex-col gap-4 md:px-8 justify-center w-full'>
            ...
            <div data-aos="fade-down" data-aos-duration="1500" className='grid grid-cols-1 gap-6 md:grid-cols-2 xl:grid-cols-3 md:gap-4 md:px-8 '>
                ...
                <div className='flex bg-white justify-center gap-6 items-center p-4 md:px-8 border border-main rounded-2xl box-border'>
                ...
                <div className='flex bg-white justify-around gap-6 items-center p-4 md:px-8  border border-main rounded-2xl'>
                ...
                <div className='flex bg-white justify-center gap-6 items-center p-4 md:px-8 border border-main rounded-2xl'>
