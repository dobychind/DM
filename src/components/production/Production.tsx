...
const Production: React.FC<{ forwardRef: React.RefObject<HTMLDivElement> }> = ({ forwardRef }) => {
  ...
  return (
    <div data-aos="fade-down" data-aos-duration="1000" data-aos-once="true" data-aos-anchor-placement="top-bottom" className='flex flex-col gap-8'>
      <div className='flex flex-col  gap-4 w-full mx-auto md:grid md:grid-cols-3 md:grid-rows-3 md:gap-8'>
        ...
        <div className="bg-[url('/ProdSmall.png')] bg-bottom p-4 col-span-2 row-span-2 rounded-2xl flex justify-center h-full bg-cover min-h-[28rem] xl:min-h-[34rem] items-center" />
