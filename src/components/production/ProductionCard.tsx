...
const ProductionCard: React.FC<ProductionCardProps> = ({ logo, name, delay }) => (
  <div data-aos="fade-down" data-aos-duration="3000" data-aos-delay={delay} className='flex flex-col bg-transparent w-full justify-end items-center h-full gap-4'>
